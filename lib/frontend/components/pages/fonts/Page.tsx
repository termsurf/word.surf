  ...
  return (
    <>
      <div className="relative w-full pb-64 flex flex-col gap-16 p-16">
        ...
        {/* <H2 className="!text-2xl !mb-0 !text-zinc-600 !border-0 text-center uppercase scale-y-80 tracking-wide-015 mt-32">
          Living
        </H2> */}
        <Grid
          minWidth={192}
...
function FontLink({
  ...
  if (disabled) {
    return (
      ...
      >
        ...
        {sample && (
          <Grid
            className="lowercase text-h4 leading-content text-zinc-300"
            minWidth={28}
            gap={8}
            maxColumns={4}
          >
  ...
  return (
    ...
    >
      ...
      {sample && (
        <Grid
          className="lowercase text-h4 leading-content text-zinc-400"
          minWidth={28}
          gap={8}
          maxColumns={4}
        >
