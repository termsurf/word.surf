...
import { SearchAnagrams } from './constants'
...
export async function searchAnagrams(source: SearchAnagrams) {
  const input = SearchAnagrams.parse(source)
  ...
  })) satisfies Array<SearchAnagramsResult>
