...
import { SearchRhymes } from './constants'
...
export async function searchRhymes(source: SearchRhymes) {
  const input = SearchRhymes.parse(source)
  ...
  })) satisfies Array<SearchRhymesResult>
